...
func Onboarding(ctx context.Context, app *firebase.App, client *firestore.Client) {
	...
	http.HandleFunc("/onboarding/register", func(w http.ResponseWriter, r *http.Request) {
	...
	http.HandleFunc("/onboarding/success", func(w http.ResponseWriter, r *http.Request) {
